...
0. Install uv and add the following to the `~/.bashrc`
...
...
  ...
  -> VISTA: module load gcc/13.2.0 openmpi/5.0.5 phdf5/1.14.4 python3_mpi/3.11.8 cuda/12.5
  -> FRONTERA: module load xalt/2.10.34 impi/21.9.0 intel/23.1.0 cmake/3.31.5
...
3. This will create 2 venvs for global and local use:
