...
class PR:
    ...
    def set_default_parameters(self):
        ...
        self.dend_gmax_KAHP = 0000.8e-3
        
        self.dend_d_Caconc = 13
        self.dend_beta_Caconc = 0.075

        self.dend_bq_KAHP = 0.001
        self.dend_aqs_KAHP = 0.00002
    ...
    def set_parameters(self, params):
        ...
        self.dend_gmax_KAHP = params.get("dend_gmax_KAHP")
        self.dend_aqs_KAHP = params.get("dend_aqs_KAHP")
        self.dend_bq_KAHP = params.get("dend_bq_KAHP")
    ...
    def biophys(self):
        ...
        for sec in [self.soma, self.dend]:
            sec.Ra = 1
            sec.Ra = (1e-6/(self.gc/self.pp * (h.area(0.5, sec=sec)*1e-8) * 1e-3))/(2*h.ri(0.5, sec=sec))
        ...
        self.dend.gmax_KAHP_PR = self.dend_gmax_KAHP
        self.dend.aqs_KAHP_PR = self.dend_aqs_KAHP
        self.dend.bq_KAHP_PR = self.dend_bq_KAHP
